...
<ul>
  ...
  <c:forEach var="book" items="${books}">
    <tr>
      ...
      <td>
       <a class="btn btn-default" style="color:#840032;border:1px solid gray;"><i class="fa fa-pencil"></i></a>
      </td>
    </tr>
  </c:forEach>
...
<div style="padding:0.3em;background-color:#333;color:white;text-align: center;">September 4, 2025: PostgreSQL 18 RC 1 Released!</div>
<script>
function myFunction() {
