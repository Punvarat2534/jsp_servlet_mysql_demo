...
<form class="form-horizontal" method="post" action="?action=update" style="margin:0 auto;width:90%;">

<div class="form-group">
    <label class="control-label col-sm-2 col-md-12" for="isbn">isbn:</label>
    <div class="col-sm-12">
      <input type="text" class="form-control" id="isbn" name="isbn" placeholder="isbn" value="${books.isbn}" required>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-12">
      <input type="text" class="form-control" id="title" name="title" placeholder="title" value="${books.title}" required>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-12">
    <textarea class="form-control" id="descrip" name="descrip">${books.description_s}</textarea>
    </div>
</div>
<br><br>
  <div class="form-group">
